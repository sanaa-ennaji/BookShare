...
<button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-md py-2 px-4 w-full">Login</button>
   ...
   {{-- <div class="flex justify-between">
    ...
    <p class="text-sm text-center text-gray-400  mt-4 mb-4">
      ...
      <a href="/register" class="font-semibold text-blue-500 focus:text-blue-600 focus:outline-none focus:underline"> sign-in </a>.
    </p>
</form>
<div class="flex flex-row justify-center mb-8">
  <span class="absolute bg-blue-50 px-4 text-gray-500">or log in with</span>
  <div class="w-full bg-gray-200 mt-3 h-px"></div>
</div>

<div class="flex flex-row gap-2">
  <a href="{{ route('google.redirect') }}" class="bg-blue-500 text-white w-full p-2 flex flex-row justify-center gap-2 items-center rounded-sm hover:bg-blue-600 duration-100 ease-in-out">
