    ...
    <div class="h-screen bg-gray-100 pt-20">
      ...
      <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
        <div class="rounded-lg md:w-2/3">
          ...
          @else
          @foreach($cartItems as $cartItem)
          <div class="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start sm:h-[20vh] ">
            <img src="img/9780399185793.jpg" alt="product-image" class="w-full rounded-lg  md:h-20  sm:w-40" />
        ...
        <form  id="create-order-form" action="{{ route('orders.create') }}" method="POST" class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
          @csrf       
