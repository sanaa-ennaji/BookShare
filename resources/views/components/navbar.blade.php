<nav
  ...
  <div class="flex w-full flex-wrap items-center justify-between w-[70vw] mx-auto px-10">
...
<form id="searchForm" class="mx-auto w-[40vw]  rounded-2xl" action="{{ route('search') }}" method="GET">
      <div class="flex">
        ...
        <div class="relative w-full"> 
            <input type="text" name="search" id="searchInput" placeholder="Search by title, author, ISBN, or price" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-full border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search ..." required />
