   ...
   <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-5 transition-transform -translate-x-full mr-10 bg-blue-500 border-r border-gray-200  sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
     ...
     <div class="h-full px-5 pb-4 overflow-y-auto bg-blue-500 dark:bg-gray-800">
        ...
        <ul class="space-y-2 font-medium">
           <li>
              <a href="/adminStatistic" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
           ...
           <li>
              <a href="/adminCategory" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
           ...
           <li>
              <a href="/adminStores" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-blue-100 dark:hover:bg-gray-700 group">
           ...
           <li>
              <a href="/adminDamandes" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <i class='bx bx-archive mr-3 text-lg text-white'></i>  
                 <span class="flex-1 ms-3 whitespace-nowrap">damandes</span>
              </a>
           </li>
           <li>
