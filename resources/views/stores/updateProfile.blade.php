        ...
        <body >
          @include('components/navbar')
            ...
            <div class="w-[80vw] mx-auto">
                ...
                <form id="upsate" action="/update/{{ Auth::user()->store->id }}" method="POST">
                    @csrf
                    @method('PUT')
                                ...
                                <div class=" mx-auto xl:mx-0">
                                    <div class="rounded relative mt-8 h-48">
                                        ...
                                        <div class="flex items-center px-3 py-2 rounded absolute right-0  mt-4 cursor-pointer">
                                            ...
                                            <input name="cover" type="file" onchange="loadFile(event)" class="block w-full text-sm text-slate-500 
                                            file:-mr-50 file:py-2 file:px-4
            ...
            <label class="block">
                ...
                <input name="image" type="file" onchange="loadFile2(event)" class="block w-full text-sm text-slate-500 
                    ...
                    hidden
                " />
                <img id='preview_img2' class="h-20 w-20 object-cover rounded-full shadow-lg cursor-pointer"
                    ...
                    alt="Current profile photo" />
                                    ...
                                    <div class="mt-10 flex flex-col xl:w-3/5 lg:w-1/2 md:w-1/2 w-full">
                                        ...
                                        <textarea id="about" name="description" required class="bg-transparent border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-blue-700 resize-none placeholder-gray-500 text-gray-600 dark:text-gray-400" placeholder="Let the world know who you are" rows="5">
                        ...
                        <div class="container mx-auto xl:w-full">
                            <div class="w-full py-4 sm:px-0 bg-white dark:bg-gray-800 flex justify-end">
                                <button class="bg-gray-200 focus:outline-none transition duration-150 ease-in-out hover:bg-gray-300 dark:bg-gray-700 rounded text-blue-600 dark:text-blue-600 px-6 py-2 text-xs mr-4 focus:ring-2 focus:ring-offset-2 focus:ring-gray-700">Cancel</button>
