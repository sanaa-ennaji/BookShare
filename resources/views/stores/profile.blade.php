  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.3.0/flowbite.min.js"></script>
    ...
    <body >
      @include('components/navbar')
        ...
        <div class="border-1 shadow-lg shadow-gray-700 sm:h-[45vh] sm:w-[80%] mx-auto" style="background-image: url(..img/pexels-tuur-tisseghem-626986.jpg)">
            <div class="flex rounded-t-lg bg-top-color sm:px-2 w-full">
                <div class="overflow-hidden rounded-full sm:relative sm:p-0 sm:top-60 top-35 h-32 w-32 sm:w-25 sm:h-25 ">
                    <img class="object-cover object-center h-32 sm:h-25" src="../img/bookstore.jpg"/>
                </div>
